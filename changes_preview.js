	...
	function loadChanges() {
		...
		function prepareChanges() {
			...
			if (usePreviewConnector()) {
				...
				oChanges = {
					changes: oResult,
					componentClassName: "com.sun.zpp_for_production"
				};
			}
		...
		return new Promise(function (resolve, reject) {
			$.ajax({
				...
				function isMTAChange(sPath) {
					...
					return sPath.startsWith("zpp_for_production_new_ext") && sPath.indexOf("webapp/changes/") > 0 && isValidChangeFileExt(sPath);
				}
